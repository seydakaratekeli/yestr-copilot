      ...
      <div className="mx-auto max-w-7xl space-y-8 px-6 py-8">
        ...
        <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-semibold">
                {project.building_type || "Belirtilmedi"}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-semibold">
                {formatArea(
                  project.total_construction_area,
                )}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-semibold">
                {project.floor_count ?? "Belirtilmedi"}
              </p>
            </CardContent>
          </Card>
        </section>
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-4">
              <DetailRow
                label="Parsel alanı"
                value={formatArea(project.parcel_area)}
              />

              <DetailRow
                label="Ana cephe yönü"
                value={
                  project.main_facade_direction ||
                  "Belirtilmedi"
                }
              />
              ...
              <DetailRow
                ...
                value={
                  project.target_certificate_level ||
                  "Belirtilmedi"
                }
              />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Analize başlamak için mimari proje,
                teknik şartname veya enerji raporu gibi
